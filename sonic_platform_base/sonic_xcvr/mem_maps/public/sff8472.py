...
class Sff8472MemMap(XcvrMemMap):
    def __init__(self, codes):
        ...
        self.SERIAL_ID = RegGroupField(consts.SERIAL_ID_FIELD,
            ...
            StringRegField(consts.VENDOR_DATE_FIELD, self.get_addr(0xA0, None, 84), size=8),
        ...
        ext_cal_deps = [consts.DIAG_MON_TYPE_FIELD,
        ...
        self.DOM = RegGroupField(consts.DOM_FIELD,
            ...
            VoltageField(consts.VOLTAGE_FIELD, self.get_addr(0xA2, 0, 98), size=2, format=">H", scale=1000),
        ...
        self.THRESHOLDS = RegGroupField(consts.THRESHOLDS_FIELD,
            ...
            VoltageField(consts.VOLTAGE_HIGH_ALARM_FIELD, self.get_addr(0xA2, 0, 8), size=2, format=">H", scale=1000),
            VoltageField(consts.VOLTAGE_LOW_ALARM_FIELD, self.get_addr(0xA2, 0, 10), size=2, format=">H", scale=1000),
            VoltageField(consts.VOLTAGE_HIGH_WARNING_FIELD, self.get_addr(0xA2, 0, 12), size=2, format=">H", scale=1000),
            VoltageField(consts.VOLTAGE_LOW_WARNING_FIELD, self.get_addr(0xA2, 0, 14), size=2, format=">H", scale=1000),
